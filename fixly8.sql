...
INSERT INTO `alembic_version` VALUES ('8df6df041153');
...
CREATE TABLE `pending_subscription` (
  ...
  UNIQUE KEY `token` (`token`),
  KEY `workshop_id` (`workshop_id`),
  CONSTRAINT `pending_subscription_ibfk_1` FOREIGN KEY (`workshop_id`) REFERENCES `workshop` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `pending_subscription`
--

LOCK TABLES `pending_subscription` WRITE;
/*!40000 ALTER TABLE `pending_subscription` DISABLE KEYS */;
/*!40000 ALTER TABLE `pending_subscription` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `subscription` (
  ...
  `created_at` datetime DEFAULT NULL,
  `whop_order_id` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `workshop_id` (`workshop_id`),
...
-- Dump completed on 2026-01-02 14:07:58
